...
<title>Carbon Digital - Verification</title>
	...
	<body>
		<div class="container">
			<h2 class="form-signin-heading">Error Upload Message</h2>
			<div class="content">								
			  <p class="center"><?php echo $this->session->flashdata('error_upload_message');?></p>
			  <hr/>
			  <div class="clearfix">
			  <a class="btn btn-danger pull-right" type="button" href="<?php echo site_url() . '/pages';?>"><i class="fa fa-times"></i> Back</a>
			  </div>
			</div>
		</div>
	</body>
